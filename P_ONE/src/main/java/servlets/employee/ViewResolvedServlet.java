...
@WebServlet(name = "ViewResolvedServlet", urlPatterns = "/viewResolved")
public class ViewResolvedServlet extends HttpServlet {
    private DBConnection db;
    private EmployeeService es;
    private ObjectMapper om;
    private static final Logger logger = LogManager.getLogger(ViewResolvedServlet.class.getName());
    @Override
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        logger.debug("inside viewResolvedServlet do get method");
        ...
        if(userSession.getAttribute("currentId") != null && userSession.getAttribute("user") == "employee") {
            ...
            ArrayList<Reimbursement> requests = es.viewResolvedRequests();
